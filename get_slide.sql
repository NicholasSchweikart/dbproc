# NOTE will not work for userId = owner, they arent in the authorized_users table.
...
BEGIN
    ...
    SELECT presentationId, classId, userId INTO presentation_id, class_id, admin_user_id FROM votodev.slides WHERE slideId = slide_id;
